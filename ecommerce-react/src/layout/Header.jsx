...
const Header = ({ showSidebar, setShowSidebar }) => {
  return (
    <div className="fixed top-0 left-0 w-full py-5 px-2 lg:px-7 z-40">
      <div className="ml-0 lg:ml-[260px] rounded h-[65px] flex justify-between items-center bg-[#b1addf] px-5 transition-all">
        <div
        ...
        <div className="hidden md:block">
          <input
            className="px-3 py-2 outline-none border bg-transparent border-slate-500 rounded-md text-[#423d72] focus:border-indigo-800 overflow-hidden transition-all"
            type="text"
            name="search"
            placeholder="Search"
          />
